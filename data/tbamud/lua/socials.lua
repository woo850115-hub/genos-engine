...
Socials["beg"] = {
    ...
    found_room = "$n begs you for money.  You graciously let $m peep at your fortune.",
...
Socials["flirt"] = {
    ...
    no_arg_room = "$n flirts outrageously.",
...
Socials["snarl"] = {
    min_victim_pos = 0,
    no_arg_char = "You snarl like a vicious animal.",
    no_arg_room = "$n snarls like a cornered, vicious animal.",
    found_char = "You snarl at $M angrily.  Control yourself!",
    found_room = "$n snarls angrily at $N.  $e$u seems incapable of controlling $mself.",
    found_victim = "$n snarls viciously at you.  $U$s self-control seems to have gone bananas.",
...
Socials["tackle"] = {
    ...
    no_arg_room = "$n starts running around $mself in a desperate attempt to tackle the air.",
    ...
    self_room = "$n makes a dexterous move and kicks $s left leg away with $s right.",
}
...
Socials["taunt"] = {
    ...
    found_room = "$n taunts $N rather insultingly.  $U$n seems to enjoy it tremendously.",
